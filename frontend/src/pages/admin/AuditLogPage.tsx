  ...
  return (
    <div className="p-6">
      <PageHeader
        ...
        description="Кто, когда и что менял в справочниках: сотрудники, рабочие места, отделы, юрлица, графики, ответственные. Плюс неудачные входы и блокировки входа (источник «Вход в систему»). Часы и отсутствия сюда не попадают."
      />
