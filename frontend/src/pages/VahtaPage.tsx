      ...
      >
        ...
        {showMoney && (
          <>
            ...
            {/* К выплате = начислено − оф. выплата − долг прошлых половин,
                вверх до 500 ₽ по половинам (task_official_payout_debt). */}
            <td
              data-col="payout"
              ...
              title={
                `Начислено минус официальная выплата минус переплата прошлых ` +
                `половин — остаток из кассы. Точно ${money(row.net_payout_exact)}, ` +
                `округлено вверх до 500 ₽ по каждой половине`
              }
            >
