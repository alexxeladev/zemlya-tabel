...
class _GuardMonthPayroll:
    ...
    * в разрезе юрлиц зарплата вахты делится по процентам МЕСТА РАБОТЫ (объекта
      ...
      ведомости. Делится ЗАРПЛАТА за смены (`total_amount`), как и у остальных
      строк дашборда: премий и налога на официальную часть в ФОТ дашборда нет.
      Поэтому суммы по юрлицам здесь меньше, чем в ведомости вахты, ровно на
      премию и налог — это не расхождение, а разные базы.
    """
