...
- **Оплата** (`absence_pay` в `app/services/payroll.py`): `оклад / норма_часов × (дни × 8)`. ОТ → `vacation_amount`, Б → `sick_amount` (100%, **без годового лимита** — лимит это часть 2). ДО и Н — 0, только отметка.
