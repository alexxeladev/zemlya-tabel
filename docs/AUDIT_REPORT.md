> ⚠ **УСТАРЕЛО: аудит от 2026-06-11.** Актуальные — `docs/project-audit.md` и `docs/AUDIT.md` (сентябрь 2026). Здесь — только история; незакрытое отсюда сведено в `docs/AUDIT.md` → 3.5.
