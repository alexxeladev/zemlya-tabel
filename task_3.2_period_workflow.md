...
- Одна большая карточка статуса:
  ...
  - Под бейджем — детали: «Отправлено 28 мая Нарядов А.В.», «Утверждено 30 мая Иванова О.П.» и т.д.
...
- 28 мая 14:23 — Нарядов А.В. отправил на проверку
- 30 мая 10:15 — Иванова О.П. вернула на доработку: «не сошёлся итог»
- 30 мая 16:40 — Нарядов А.В. снова отправил на проверку
